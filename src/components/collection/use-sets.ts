...
const COLUMNS =
  'set_id, code, name, family, subtitle, season, required_count, commit_payout_pct, sort_order, total_cards, committed, ready, complete, milestones, total_reward, claimable_coins, claimed_coins, next_at, next_reward, min_tier';
