...
const DIRECTORY_ROWS: { player: DirectoryPlayer; fixture?: string }[] = [
  {
    player: {
      ...
      seasonFp: 236.4, gamesPlayed: 16, fpPerGame: 14.8, posRank: 8, overallRank: 12, marketRank: 12,
  ...
  },
  {
    player: {
      ...
      seasonFp: 232.6, gamesPlayed: 15, fpPerGame: 15.5, posRank: 11, overallRank: 15, marketRank: 15,
  ...
  },
  {
    player: {
      ...
      seasonFp: 198.2, gamesPlayed: 12, fpPerGame: 16.5, posRank: 4, overallRank: 31, marketRank: 31,
  ...
  },
  {
    player: {
      ...
      seasonFp: 288.1, gamesPlayed: 17, fpPerGame: 16.9, posRank: 5, overallRank: 2, marketRank: 2,
  ...
  },
  {
    player: {
      ...
      seasonFp: 141.0, gamesPlayed: 16, fpPerGame: 8.8, posRank: 3, overallRank: 96, marketRank: 96,
  ...
  },
  {
    ...
    player: {
      ...
      seasonFp: 0, gamesPlayed: 0, fpPerGame: 0, posRank: null, overallRank: null, marketRank: null,
